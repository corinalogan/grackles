...
**P4 alternative 1:** Individuals will continue to prefer a mixture of learning strategies, and/or they do not converge on the more functional epsilon-first learning strategy, regardless of how many reversals they participate in. This pattern could suggest that the epsilon-decreasing and epsilon-first strategies do not capture the types of learning strategies used by this species. The epsilon-decreasing strategy is broad (exploration-based trial and error learning) and a variety of exploration strategies could be operating within this category (e.g., always choose the left side, alternate sides for each choice, etc.). 

**P4 alternative 2:** Individuals will continue to prefer a mixture of learning strategies, and/or they do not converge on the more functional epsilon-first learning strategy, regardless of how many reversals they participate in. This pattern could suggest that the grackles do not attend to functional meta-strategies, that is, they do not learn the rule (once food is found in the non-preferred tube, one must switch to preferring that tube color), but rather they learn each change in preference as if it was new.
