...
#load the Rmd file
Rmd <- readChar("https://raw.githubusercontent.com/corinalogan/grackles/master/Files/Preregistrations/gxpopbehaviorhabitatBTGR.Rmd",nchars=1e7)
...
write(allbibtexkeys,file="gxpopbehaviorhabitatBTGR_bibtexkeys.txt")

#load the cleaned txt file
allbibtexkeys<-read.csv("gxpopbehaviorhabitatBTGR_bibtexkeys.txt")
...
df2bib(df_filtered, file = "xpopBTGRrefs.bib", append = FALSE)
```

[![PCI RR badge](badge_PCI_RR.png)](https://doi.org/10.24072/pci.rr.100995)
...
Shafiei Sabet, S., and Mazza, V. (2025) The role of behavior and habitat availability on species geographic expansion. *Peer Community in Registered Reports*. [https://doi.org/10.24072/pci.rr.100995](https://doi.org/10.24072/pci.rr.100995). Reviewed by Vedrana Šlipogor and Molly Gilmour.

**Cite as:** Logan CJ, McCune KB, Rowney C, Lukas D. 2025. Behavioral flexibility is similar in two closely related species where only one is rapidly expanding its geographic range. EcoEvoRxiv, version 3, peer reviewed and recommended by *Peer Community in Registered Reports*. doi: https://doi.org/10.32942/X2Q038
...
b[individual] ~ Normal(0, $\sigma$[site]),
