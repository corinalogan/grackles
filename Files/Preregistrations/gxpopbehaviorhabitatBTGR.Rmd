...
```{r foodswitchresult, eval=F, results='hide'}
...
## R has been updated and now the rethinking package doesn't work. Here is how to reload everything

#First https://github.com/stan-dev/rstan/wiki/Installing-RStan-from-Source#mac
