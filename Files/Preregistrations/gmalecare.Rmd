...
@cohen1988statistical approximates small effect sizes at f^2^=0.20, medium at f^2^=0.50, and large at f^2^=0.80. This means that, with a projected sample size of 9 and a f^2^=1.5, we have a 71% chance of detecting only very large effects.  
...
@cohen1988statistical approximates small effect sizes at f^2^=0.20, medium at f^2^=0.50, and large at f^2^=0.80. This means that, with a projected sample size of 9 and a f^2^=2.2, we have a 71% chance of detecting only very large effects.  
