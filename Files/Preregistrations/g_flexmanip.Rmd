...
6) Batch (random effect because repeated measures on the same individuals)
...
# Checking the residuals using the R package DHARMa (https://cran.r-project.org/web/packages/DHARMa/vignettes/DHARMa.html)
library(DHARMa)
simulationOutput <- simulateResiduals(fittedModel = fittedModel, n=250) #250 simulations, but if want higher precision change n>1000
