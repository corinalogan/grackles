...
model <- MCMCglmm(TrialsToReverse ~ ReverseNumber, random = ~ID+Batch, family = "poisson", data = d, verbose = F, prior = prior, nitt = 300000, thin = 500, burnin = 90000)
...
plot(modelcheck)
#KS test p=0.06 so not heteroscedastic, dispersion test p=0.88 so not dispersed, outlier test p=1 so not zero inflated, residual vs predicted: no significant problems detected.
...
# using glm - we ended up using this in the article
