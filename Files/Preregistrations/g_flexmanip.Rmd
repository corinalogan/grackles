...
Behavioral flexibility, the ability to adapt behavior to new circumstances (see @mikhalevich_is_2017 for the theoretical background on this definition), is thought to play an important role in a species' ability to successfully adapt to new environments and expand its geographic range [e.g., @lefebvre1997feeding; @sol2000behavioural; @sol2002behavioural; @sol2005big; @sol2007big]. This research predicts that behavioral flexibility should positively relate with innovativeness. However, these predictions are based on species-level data and proxies for flexibility and for innovation when examining such relationships [see @logan2018beyond]. Behavioral flexibility is rarely directly tested in species that are rapidly expanding their geographic ranges in a way that would allow us to determine how flexibility works and how we can make predictions about a species' ability to adapt their behavior to new environments [but see @chow2016practice, ]. 

Here, we aimed to determine whether flexibility relates to innovativeness at the intra-species level in a species that is behaviorally flexible [@logan2016behavioral] and is rapidly expanding its geographic range [@wehtje2003range; @peer2011invasion]. 

We use great-tailed grackles (a bird species) as a model to investigate this question because they have rapidly expanded their range into North America over the past 140 years [@wehtje2003range; @peer2011invasion]. We attempted to manipulate grackle behavioral flexibility (color tube reversal learning) to determine whether their flexibility is generalizable across contexts (touch screen reversal learning and multi-access box), whether it is repeatable within individuals and across contexts, and what learning strategies they employ.
...
d <- read.csv ("/Users/corina/ownCloud/Documents/GitHub/grackles/Files/Preregistrations/gflexmanip_table_simtoeffectsize.csv", header=F, sep=",", stringsAsFactors=F) 
...
d <- read.csv ("/Users/corina/ownCloud/Documents/GitHub/grackles/Files/Preregistrations/gflexmanip_table_minsamplesizesim.csv", header=F, sep=",", stringsAsFactors=F) 
...
seriald <- read.csv ("/Users/corina/ownCloud/Documents/GitHub/grackles/Files/Preregistrations/g_flexmanip_data_reverse.csv", header=T, sep=",", stringsAsFactors=F) 
