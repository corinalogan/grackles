...
library(rethinking)
PI(condition$Sol[,1],prob=0.89) #4.12 to 4.46
PI(condition$Sol[,2],prob=0.89) #-0.27 to 0.11
...
tb <- data.frame(tb)
colnames(tb) <- c("","Posterior mean","Lower 89 percentile compatibility interval (5%)","Upper 89 percentile compatibility interval (94%)","Effective sample size","pMCMC","Significance code: **=0.01")
...
colnames(cond) <- c("","Posterior mean","Lower 89 percentile compatibility interval (5%)","Upper 89 percentile compatibility interval (94%)","Effective sample size","pMCMC","Significance code: **=0.01")
