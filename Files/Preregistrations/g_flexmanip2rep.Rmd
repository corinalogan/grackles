...
![](g_flexmanip_tubesMABs_fig1.png){width=50%}
...
![](g_flexmanip2rep_rep within context.png){width=75%}
...
![](g_flexmanip2rep_Fig3.jpeg){width=75%}
...
png(file = "Figure 2", width = 1300, height = 900, units = "px")
