...
**Post-study manuscript** submitted to PCI Ecology for post-study peer review on 3 Jan 2022; revised post-study manuscript and per reviewer comments this piece was split from the other, distinct components of the preregistrations and resubmitted on 15 Aug 2022; additional reviewer feedback is now incorporated we submit this revised version to PCI Ecology: revised preprint [pdf](https://doi.org/10.32942/X2R59K) at EcoEvoRxiv, [rmd](https://github.com/corinalogan/grackles/blob/master/Files/Preregistrations/g_flexmanip2rep.Rmd)
