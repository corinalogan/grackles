...
#### H2: Performance on the social learning task will vary among grackles in the different populations included in this study (core, middle of the expansion, and at the range edge).

P5: Individuals from the population on the edge of the grackle range will out-perform grackles from the middle of the expanded range, and the original core of the range. This may occur because social information is particularly useful to individuals in novel environments (i.e social learning strategy of "copy when uncertain" [@laland2004social]).

P5 alternative 1: Individuals from the population in the core of the grackle range will out-perform grackles from the middle and the edge of the expanded range. This may occur because the lack of novelty in the endemic range may result in selection on efficient individual learning (i.e. producers) which leads to the production of high quality public social information. When all social information is high quality, individuals may be selected to use it when it is available ([@laland2004social]).

P5 alternative 2: Individuals from the the middle of the expanded range will out-perform grackles from the population on the edge of the grackle range, and the original core of the range. This is potentially because ...

P5 alternative 3: There will be no difference in performance on the social learning task across grackle populations. This is potentially because grackles in each population are equally social and generalist foragers ([@levebvre1996is]), measured in a separate preregistration (http://corinalogan.com/Preregistrations/g_flexforaging.html).
...
We will attempt to counterbalance demonstrators among the groups such that each group will observe a demonstrator that was trained in a distinct solving method, and observers in each group will not be exposed to other demonstrators using different opening methods. 
