...
author: "McCune KM (University of California Santa Barbara), [McElreath R](http://xcelab.net/rm/) (Max Planck Institute for Evolutionary Anthropology, MPI EVA), [Logan CJ](http://CorinaLogan.com) (MPI EVA, corina_logan@eva.mpg.de)"
date: "`r Sys.Date()`"
output:
  html_document: 
    toc: true
