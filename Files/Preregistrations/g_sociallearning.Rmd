...
4) The number of times the naive focal individual observed conspecifics attempting/solving at a particular locus before the focal individual's first interaction there

5) Binary variable indicating whether the focal individual saw another individual succeed (obtain food) or just attempt (did not obtain food) at a particular locus before the focal individual's first interaction there
...
6) Random effect: ID (to partition within individual and between individual variance in performance to calculate an ICC)
