...
**P4 alternative 1:** Individual flexibility is not related to having stronger bonds, potentially because all individuals are able to form bonds with like individuals, including the less flexible individuals.
...
1) Strength of the maximum bond (calculated as the half-weight index based on association behavior during focal follows). If we are unable to sample each individual at least four times (@mccune_2018), we will instead use an individual's degree (maximum number of other individuals that the focal subject associated with; @wey2008social).
...
#GLMM 3 with response variable = MaleSharesTerritory
#female
...
#GLMM 4 with response variable = RelatednessForMaxBond
#female
