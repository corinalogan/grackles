...
**Analysis:** This is a descriptive analysis where we will visualize the food types eaten per individual and then order the individuals according to their flexibility scores on their most recent reversal learning color tube experiment. This will allow us to see whether the more flexible individuals (faster to reverse) eat different food types from the less flexible individuals.
