...
### ICCs for agreement between the 2 coders for 6-7 variables
...
#ICC for microhabitat is not working, tried some things, but still not working. Agreement was 100% though so ICC=1.00
km$X1Microhabitat <- as.factor(km$X1Microhabitat)
km$X1Microhabitat <- as.numeric(km$X1Microhabitat)
icc(km[,c(12,13)], model="oneway", type="agreement", unit="single", conf.level=0.95) #Microhabitat
...
#ICC for microhabitat is not working, tried some things, but still not working. Agreement was 100% though so ICC=1.00
icc(mf[,c(12,13)], model="oneway", type="agreement", unit="single", conf.level=0.95) #Microhabitat
...
icc(clr[,c(13,14)], model="oneway", type="agreement", unit="single", conf.level=0.95) #Microhabitat
icc(clr[,c(15,16)], model="oneway", type="agreement", unit="single", conf.level=0.95) #Group size
```

**ICCs for McCune (n=6 focal follows, Bergeron=baseline):**

Different Foods Eaten = 1.00

Different Foraging Techniques = 0.97 (95% confidence interval=0.823-1.00)

Number of Affiliative Interactions = 0.96 (95% confidence interval=0.794-1.00)

Number of Aggressive Interactions = 1.00 (95% confidence interval=0.986-1.00)

Number of Initiated Aggressive Interactions = 1.00 (95% confidence interval=0.974-1.00)

Microhabitat = 1.00

**ICCs for Folsom (n=6 focal follows, Bergeron=baseline):**

Different Foods Eaten = 1.00

Different Foraging Techniques = 1.00

Number of Affiliative Interactions = 1.00

Number of Aggressive Interactions = 0.96 (95% confidence interval=0.779-0.994)

Number of Initiated Aggressive Interactions = 0.94 (95% confidence interval=0.696-0.991)
...
**ICCs for Rolls (n=17 focal follows, McCune=baseline):**

Different Foods Eaten = 0.92 (95% confidence interval=0.802-0.971)

Different Foraging Techniques = 0.91 (95% confidence interval=0.767-0.965)

Number of Affiliative Interactions = 0.90 (95% confidence interval=0.760-0.964)

Number of Aggressive Interactions = 0.94 (95% confidence interval=0.779-0.994)

Number of Initiated Aggressive Interactions = 0.95
