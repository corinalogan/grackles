...
![](Files/Preregistrations/logoPCIecology.png){width=50%}

**Cite as:** Logan CJ, Bergeron L, McCune K, Folsom M, Lukas D. In principle recommendation 2019. Is behavioral flexibility related to foraging and social behavior in a rapidly expanding species? PCI Ecology.
![](Files/Preregistrations/logoOpenAccess.png){width=5%}
![](Files/Preregistrations/logoOpenCode.png){width=5%}
![](Files/Preregistrations/logoOpenPeerReview.png){width=5%}
