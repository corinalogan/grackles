...
author: '[Logan CJ](http://CorinaLogan.com) (Max Planck Institute for Evolutionary Anthropology, MPI EVA, corina_logan@eva.mpg.de), [Lukas D](http://dieterlukas.strikingly.com) (MPI EVA), LeGrande-Rolls C (MPI EVA), Bergeron L (University of California Santa Barbara, UCSB), Folsom M (MPI EVA), McCune KB (UCSB)'
date: '`r Sys.Date()`'
output:
  html_document: 
    toc: true
