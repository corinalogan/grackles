...
**P8:** Flexible individuals will not be associated with presence in diverse microhabitats not necessarily because they are specialists or generalists in specific foraging strategies, but rather because they may focus on high quality resources in particular habitat types. If this prediction is supported, we will conduct an additional analysis to examine the percentage of time spent in each microhabitat type, which will allow us to determine whether the more flexible individuals use particular microhabitats more than the less flexible individuals.
...
Proportion of diet per individual that is human food
...
Proportion of time spent in each habitat type (grass, gravel and other natural substrate, cement, cafe, dumpster)
...
**Analysis:** We will examine the food types eaten per individual and relate this to their flexibility scores on their most recent reversal learning color tube experiment. This will allow us to see whether the more flexible individuals (faster to reverse) eat different food types from the less flexible individuals.
...
**Analysis:** We will examine the proportion of time spent in each microhabitat per individual and relate this to their flexibility scores on their most recent reversal learning color tube experiment. This will allow us to see whether the more flexible individuals (faster to reverse) spend more time in particular microhabitats than the less flexible individuals.
