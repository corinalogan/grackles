...
**Cite as:** Logan CJ, Johnson-Ulrich Z, Bergeron L, Rowney C, Seitz B, Folsom M, Blaisdell A, McCune K, Wascher CAF. 2019. Are the more flexible individuals also better at inhibition? (version: [6 Mar 2019](https://github.com/corinalogan/grackles/blob/master/Files/Preregistrations/g_inhibition.Rmd)) In Principle Recommendation by PCI Ecology.
