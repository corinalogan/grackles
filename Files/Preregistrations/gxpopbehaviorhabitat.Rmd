...
```{r table1, eval=TRUE, warning=FALSE, results='asis', echo=F, include=TRUE}
...
```{r tableN, eval=TRUE, warning=FALSE, results='asis', echo=F, include=TRUE}
...
```{r sim_power_philambda, eval=F, warning=FALSE, results='asis', echo=F, include=TRUE}
library(rethinking)
library(dplyr)
...
```{r innovation, eval=FALSE, warning=FALSE, results='asis', echo=F, include=TRUE}
library(rethinking)
library(rstan)
...
```{r tableparam, eval=TRUE, warning=FALSE, results='asis', echo=F, include=TRUE}
...
```{r figInnovationMinN, eval=F, warning=FALSE, results='asis', echo=F, include=TRUE}
...
```{r exploration, eval=FALSE, warning=FALSE, results='asis', echo=F, include=TRUE}
library(rethinking)
library(rstan)
library(Rcpp)
...
```{r modelpersistence, eval=FALSE, warning=FALSE, results='asis', echo=F, include=TRUE}
library(rethinking)
library(rstan)
library(Rcpp)
...
```{r repeatablePer, eval=FALSE, warning=FALSE, results='asis', echo=F, include=TRUE}
#Persistence
...
```{r repeatableExpObj, eval=FALSE, warning=FALSE, results='asis', echo=F, include=TRUE}
...
```{r hab, eval=FALSE, warning=FALSE, results='asis', echo=F, include=TRUE}
#Load packages
library(auk)
library(dismo)
library(raster)
