...
***Vincent Kiepsch*** (compared with Alexis Breen's video coding): 

 - Exploration: latency to land on the ground unweighted Cohen's Kappa=0.? (confidence boundaries=0.81-1.00, n=63 data points) 
...
ab <- as.numeric(data[,2]) #coder 1
vk <- as.numeric(data[,4]) #coder 2

icc(data[,c(2,4)], model="oneway", type="consistency", unit="single", conf.level=0.95) 
#ICC=; upper and lower CIs = -, n = 32
```
