...
mu_9 <- link( output_5 , data=data.frame( populationdifference=sequence_mean_differences,samplesize=rep(1,17) ) )
mu_9_mean <- apply( mu_9 , 2 , mean )
mu_9_ci <- apply( mu_9 , 2 , PI , prob=0.97 )
shade( 1-mu_9_ci , 1/(1100*sequence_mean_differences) , col=col.alpha("blue",0.4) )

mu_12 <- link( output_5 , data=data.frame( populationdifference=sequence_mean_differences,samplesize=rep(2,17) ) )
mu_12_mean <- apply( mu_12 , 2 , mean )
mu_12_ci <- apply( mu_12 , 2 , PI , prob=0.97 )
shade( 1-mu_12_ci , 1/(1100*sequence_mean_differences) , col=col.alpha("orange",0.4) )

mu_15 <- link( output_5 , data=data.frame( populationdifference=sequence_mean_differences,samplesize=rep(3,17) ) )
mu_15_mean <- apply( mu_15 , 2 , mean )
mu_15_ci <- apply( mu_15 , 2 , PI , prob=0.97 )
shade( 1-mu_15_ci , 1/(1100*sequence_mean_differences) , col=col.alpha("skyblue",0.4) )


mu_18 <- link( output_5 , data=data.frame( populationdifference=sequence_mean_differences,samplesize=rep(4,17) ) )
mu_18_mean <- apply( mu_18 , 2 , mean )
mu_18_ci <- apply( mu_18 , 2 , PI , prob=0.97 )
shade( 1-mu_18_ci , 1/(1100*sequence_mean_differences) , col=col.alpha("#213940",0.4) )

mu_24 <- link( output_5 , data=data.frame( populationdifference=sequence_mean_differences,samplesize=rep(6,17) ) )
mu_24_mean <- apply( mu_24 , 2 , mean )
mu_24_ci <- apply( mu_24 , 2 , PI , prob=0.97 )
shade( 1-mu_24_ci , 1/(1100*sequence_mean_differences) , col=col.alpha("yellow",0.4) )
