...
***Lea Gihlein*** (compared with experimenter's live coding): 
 ...
 - Multiaccess box: correct choice unweighted Cohen's Kappa=0. (confidence boundaries=0.-.00, n= data points) 
...
***Lea Gihlein*** (compared with experimenter's live coding): 
 ...
 - Reversal learning: correct choice unweighted Cohen's Kappa=.00 (confidence boundaries=.00-.00, n= data points) 
...
# did video coder Lea Gihlein pass interobserver reliability training? 
...
# Note: c(3,5) is telling R to look at columns 2 and 3 and compare them. Double check this:
lea[,3] #coder 1 (live coder)
lea[,5] #coder 2 (video coder)
cohen.kappa(lea[,c(3,5)], w=NULL,n.obs=NULL,alpha=.05,levels=NULL) 
