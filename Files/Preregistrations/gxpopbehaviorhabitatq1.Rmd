...
#sample size
length(fvar$Phi) #38. This matches the data sheet
...
#a[1]     -3.20 0.23 -3.54 -2.87   850  1.01
#a[2]     -3.27 0.16 -3.54 -3.04   594  1.01
#a_bar    -2.88 0.70 -3.54 -1.40   237  1.01
#a_sigma   0.62 0.71  0.05  2.10   252  1.01
#sigma[1]  0.05 0.01  0.03  0.06  1160  1.00
#sigma[2]  0.02 0.00  0.02  0.03   941  1.00
#b         0.60 0.20  0.30  0.91   319  1.01
...
#           mean     sd    5.5%   94.5%      histogram
#V1      0.05 0.01 0.03  0.06    ▁▂▅▇▅▃▂▁▁▁▁▁
#V2      0.02 0.00 0.02  0.03         ▁▃▇▂▁▁▁
...
#        mean     sd    5.5%   94.5%      histogram
#V1      2.24 0.39 1.71  2.95       ▁▅▇▂▁▁▁▁
#V2      0.82 0.15 0.62  1.09 ▁▁▃▇▅▃▂▁▁▁▁▁▁▁
#diff_12 1.42 0.42 0.83  2.17      ▁▁▂▇▃▁▁▁▁
#Woodland has a higher lambda variance than Tempe bc diff does not cross zero
```
