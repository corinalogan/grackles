...
#remove NAs from the variables that will be in the model
e1 <- subset(e,!(is.na(e["Lat20cm"])))




# persistence
## see code in r code chunk "resltspersist" for the persistence calculation. I presume you will need a data sheet that separates individuals by test (reversal or MAB), which should be doable by adding a bit to that code
```
