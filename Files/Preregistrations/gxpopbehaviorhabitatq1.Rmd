...
acutal_manipulationeffects <- 0.08
...
actual_n_site1 <- 25 #Woodland
actual_n_site2 <- 20 #Tempe
simp_site = c(rep(1,n_sim/2),rep(2,n_sim/2)) #site is a categorical variable: sites 1 or 2
actual_site = c(rep(1,actual_n_site1),rep(2,actual_n_site2))
simp_treat =  sample(0:1,size=n_sim,replace=T) #treatment is a categorical variable: manipulated or not
actual_treat = c(rep(0,actual_n_site1),rep(0,12),rep(1,8)) #12 non-manip birds in Tempe and 8 manip
