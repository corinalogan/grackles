...
# COPIED FROM INNOVATION visualize each bird at each site
...
plot(indphisite~individualsatsite$Site,xaxt="n",xlab="",ylab=expression(Phi),cex.lab=1.5,cex=1.5,cex.axis=1.5, pch=c(1,4)[d$Treatment])
points(precis(fit,depth=2)[1:2,1]~c(1,2),cex=3,col="blue",pch=2)
lines(c(precis(fit,depth=2)[1,3],precis(fit,depth=2)[1,4])~c(1,1),col="blue")
lines(c(precis(fit,depth=2)[2,3],precis(fit,depth=2)[2,4])~c(2,2),col="blue")
...
plot(d$indlambdasite~individualsatsite$Site,xaxt="n",xlab="",ylab=expression(Lambda),cex.lab=1.5,cex=1.5,cex.axis=1.5, pch=c(1,4)[d$Treatment])
points(precis(fit,depth=2)[1:2,1]~c(1,2),cex=3,col="blue",pch=2)
lines(c(precis(fit,depth=2)[1,3],precis(fit,depth=2)[1,4])~c(1,1),col="blue")
lines(c(precis(fit,depth=2)[2,3],precis(fit,depth=2)[2,4])~c(2,2),col="blue")
mtext("Woodland",side=1,outer=FALSE,adj=0,font=1,cex=1.5,line=1,at=0.9)
