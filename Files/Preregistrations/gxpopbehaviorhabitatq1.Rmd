...
colnames(sumtable) <- c("Population","Batch","ID","Bird name","Sex","Learning speed","Reversal speed","MAB loci solved","MAB max loci available","Exploration latency","Persistence","Notes")
...
#5      BTGR         48 0.02827357  3.0942959         Roseling
