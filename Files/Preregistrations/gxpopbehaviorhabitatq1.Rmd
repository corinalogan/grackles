...
**Table 5.** Contrasts between sites for the innovation measure: the number of loci solved on the multi-access box.
...
**Table 7.** Contrasts between sites for the persistence measure: proportion of trials participated in across the reversal and multi-access box experiments.

```{r resltspersisttable, eval=T, warning=FALSE, results='asis', include=TRUE}
library(kableExtra)
exptable <- read.csv(url("https://raw.githubusercontent.com/corinalogan/grackles/master/Files/Preregistrations/gxpopbehaviorhabitatq1_TablePersist.csv"), header=F, sep=",", stringsAsFactors=F)
exptable <- data.frame(exptable)
colnames(exptable) <- c("","Mean","Standard deviation","Lower 89 percentile compatibility interval (5.5%)","Upper 89 percentile compatibility interval (94.5%)")
...
**Figure 10.** The proportion of trials participated in across the reversal and multi-access box experiments was the measure of persistence per individual at each site (n= Sacramento, n= Tempe).
