...
#to get the numbers X in mean(drawsdf[(,i+X)]), run names(drawsdf) and look for where v_ID.1.1. for lambda starts and v_ID.1.2 for phi starts
for (i in 1:dat$N_id){
...
#Phis and lambdas for each individual
#write.csv(individualsatsite,file="individualphilambdaBTGR.csv")
...
#NEW - need the name
#1      BTGR         40 0.03951737  3.271042
#2      BTGR         41 0.01847618  4.295592
