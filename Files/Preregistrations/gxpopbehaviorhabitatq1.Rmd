...
**Figure 9.** Average latency to approach within 20 cm of a novel environent in the exploration assay per individual at each site. Note that if an individual did not approach to within 20 cm of the novel environment at Time 1 or 2, they were given a ceiling value of 2701, which is one second longer than the session length.
