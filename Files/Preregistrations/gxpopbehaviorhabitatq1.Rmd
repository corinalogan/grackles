...
*Persistence... is hypothesized to negatively correlate with flexibility, however we have previously found that these two traits are independent of each other. Persistence is not often measured, and not in the context of population differences in invasive species where edge and core populations are compared.*

In conclusion, rather than flexibility being associated with a rapid geographic range expansion, as is widely hypothesized, we found that an increase in innovation and a decrease in exploration were the key behavioral traits associated with the great-tailed grackle's edge population in comparison with an older population closer to the original range. 
