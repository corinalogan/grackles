...
# exclude the birds who didn't complete reversal 1? no because not using this data to predict performance on the MAB or anything, just want to see if there are differences with GTGR. Don't need to add treatment to the model because there was no difference between manipulated and non-manipulated grackles in the analyses in the Results section
