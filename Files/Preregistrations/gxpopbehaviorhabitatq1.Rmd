...
#      Site unique.id.        phi   lambda
#1     BTGR         44 0.03957788 6.038243
#2     BTGR         45 0.02231290 3.183476
#3     BTGR         46 0.03536739 4.675341
#4     BTGR         47 0.02461878 5.535139
#5     BTGR         48 0.02827357 3.094296 
...
#Run the contrast
post1$diff_12 <- post1$a[,1] - post1$a[,2] #subtract mu for site 2 from mu for site 1. col1=site 1, col2=site 2
post1$diff_13 <- post1$a[,1] - post1$a[,3] #subtract mu for site 3 from mu for site 1. col1=site 1, col3=site 3
precis(post1,depth=2)
#         mean   sd  5.5% 94.5%       histogram
#a[1]     0.36 0.11  0.19  0.53  ▁▁▂▃▅▇▇▅▃▂▁▁▁▁
#a[2]     0.76 0.04  0.69  0.83 ▁▁▁▁▁▂▃▅▇▇▇▅▂▁▁
#a[3]     0.50 0.06  0.40  0.60        ▁▁▅▇▇▃▁▁
#diff_12 -0.41 0.12 -0.59 -0.22        ▁▁▃▇▇▃▁▁
#diff_13 -0.14 0.13 -0.34  0.07        ▁▂▅▇▅▂▁▁
#there is no difference between innovativeness in BTGR and GTGR in Tempe, but BTGR is less innovative than GTGR in Woodland
...
#Run the contrast
postp$diff_12 <- (postp$a[,1]) - (postp$a[,2]) #subtract mu for site 2 from mu for site 1. col1=site 1, col2=site 2
postp$diff_13 <- (postp$a[,1]) - (postp$a[,3]) #subtract mu for site 3 from mu for site 1. col1=site 1, col3=site 3
precis(postp,depth=2) 
#         mean   sd  5.5% 94.5%      histogram
#a[1]     0.69 0.02  0.66  0.72 ▁▁▁▁▂▃▇▇▇▅▃▁▁▁
#a[2]     0.78 0.01  0.77  0.79    ▁▁▁▂▅▇▇▃▁▁▁
#a[3]     0.79 0.01  0.78  0.80    ▁▁▁▁▂▅▇▅▂▁▁
