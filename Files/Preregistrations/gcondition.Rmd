...
d <- read.csv("data_condition.csv", header=T, sep=",", stringsAsFactors=F) 
...
colnames(d) = c("Date","Aviary","ID","FatScore","mass","Ltarsus","Rtarsus","tarsus","Lwing","Rwing","wing","Season","Experimenter","notes")

### Determine which measure will go into the calculaation of SMI to be the "Body" variable ###
