...
2) Male held a territory (1 to 3 clumped trees defended against other males) that contained at least one active nest (yes, no)
...
bs <- glm(Body ~ Season, family = "gaussian", data = d)
