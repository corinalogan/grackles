...
### HYPOTHESES
We compared two measures of body condition in grackles and observed reproductive success to test two hypotheses:
...
kbl(p1, col.names = colnames,align = c("l","c","c","c","c")) %>% 
