...
# describe(h2_m$Body)
# par(mfrow = c(1,2))
# hist(h2_m$Body, main = "Male SMI category cutpoints", xlab = "SMI score")
# abline(v = c(159.5,170.3,154.1,175.7),col="blue")
# abline(v=164.9, col="red")
# hist(h2_f$Body, main = "Female SMI category cutpoints",xlab = "SMI score")
# abline(v = c(98.3,90.5,102.1,86.7),col="blue")
