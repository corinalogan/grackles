...
#GLMM fledglings
m1 <- MCMCglmm(Fledglings ~ FatScore + Aviary, random=~Year, family="categorical", data=d, verbose=F, prior=prior, nitt=130000, thin=10, burnin=30000)
summary(m1)
#autocorr(m1$Sol) #Did fixed effects converge?
#autocorr(m1$VCV) #Did random effects converge?

#GLMM territory holder
m2 <- MCMCglmm(Territory ~ FatScore + Aviary, random=~Year, family="categorical", data=d, verbose=F, prior=prior, nitt=130000, thin=10, burnin=30000)
summary(m2)
