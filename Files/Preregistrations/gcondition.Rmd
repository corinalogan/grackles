...
2) Male held a territory consisting of 1 to 3 clumped trees containing at least one active nest (yes, no)
...
1) 1) Scaled mass index using body weight and measures of tarsus length or flattened wing length (average of left and right as in @bleeker2005body). We will choose the skeletal body size measure that is most correlated with body weight (@pieg2009new).

2) Season (non-breeding [Sep-Feb], breeding [Mar-Aug])

3) Random effect: Experimenter (because several different experimenters measured fat score on multiple different birds)
...
2) Temporarily held in aviaries for behavioral testing at any point during this study, since this may affect breeding behaviors (yes, no)
