...
\includegraphics[width=0.05\textwidth,height=\textheight]{logoOpenData.png}
\includegraphics[width=0.05\textwidth,height=\textheight]{logoOpenCode.png}
\includegraphics[width=0.05\textwidth,height=\textheight]{logoOpenPeerReview.png}
...
Based on the GIS-coordinates of each trapping location, we calculate
pairwise distances between all pairs of individuals.
...
The first analysis investigates whether average relatedness among all
females or among all males is different than that observed in random
samples.
...
The second analysis investigates whether closely related individuals
were trapped at closer distances from each other than random pairs of
individuals.
