...
**After data collection had begun (and before any data analysis was conducted):** This preregistration was reviewed at PCI Ecology, revised, and resubmitted (Feb 2019).
...
**ANALYSIS 1** - *P1-P5: flexibility correlates with exploratory behaviors*
...
**ANALYSIS 2** - *P1 alternative 4: correlation between boldness and exploration*
...
**ANALYSIS 3** - *P3: does persistence correlate with reversal persistence?*
...
**ANALYSIS 4** - *P6: repeatability of boldness, exploration and persistence*
