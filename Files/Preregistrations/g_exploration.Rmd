...
author: 'McCune KB (University of California Santa Barbara, UCSB), Rowney C (Max Planck Institute for Evolutionary Anthropology, MPI EVA), Bergeron L (UCSB), Folsom M (MPI EVA), [Logan CJ](http://CorinaLogan.com) (MPI EVA, corina_logan@eva.mpg.de)'
date: '`r Sys.Date()`'
output:
  html_document: 
    toc: true
