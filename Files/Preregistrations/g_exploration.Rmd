...
ee$LatencyFirstLand[which(ee$VideoFileName=="A064LR 2019-10-30 ExploreEnv Time1 Familiar T1 Part2")]<-NA # fixed latency because pt. 2 had 3400, but part 1 already listed the latency.
...
# *KM gets p = 0.035 here, data not normally distributed. 
...
# 8 Feb 2021: But have to log-transform Latency so residuals are normally distributed
library(MCMCglmm)
prior = list(R=list(R1=list(V=1,nu=0)), G=list(G1=list(V=1,nu=0)))
...
# *KM sees all values after lag 0 are <0.1 indicating they converged.
autocorr(explo$VCV) #Did random effects converge? No
# *KM sees two values >0.1, increased nitt (to 630,000) and thin (to 1,000), then all values <0.1
