...
# additional analysis using only the Environment condition to determine repeatability, which will inform who we choose to code videos for our next field site
de <- d[d$Experiment=="Environment",] 
head(de)  
cohen.kappa(de[,c(4,6)], w=NULL,n.obs=NULL,alpha=.05,levels=NULL)
# unweighted kappa=0.76, confidence boundaries: 0.45-1.00, n=16 data points
...
# ICC = 0.75 (95% Confidence Interval: 0.71-0.78, n=32 data points)
