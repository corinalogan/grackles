...
5) Number of touches to the functional part of an apparatus per time (multi-access box, novel environment in P1, novel objects in P2 and P4) 

6) Number of touches to the non-functional part of an apparatus per time ([multi-access box](./g_flexmanip.html)) 

*P4: boldness*

7) Latency to land on the table - OR - Latency to eat the food - OR - Latency to touch a threatening object next to food (choose the variable with the most data)
...
9) Age (adult: after hatch year, juvenile: hatch year). NOTE: this variable will be removed if only adults are tested (and we are planning to test only adults).

10) ID (random effect because multiple measures per individual)
