...
AZm1.dur.red = MCMCglmm(log(hr) ~ DurationNear + Sex + History + Breeding.Sites + Food.Sites + Group.Size + Season, family="gaussian", data=HR, verbose=F, nitt=100000, thin=50, burnin=8000)
