...
smi$BirdID[which(smi$BirdID == "Molé")] <- "Mole"
smi$BirdID[which(smi$BirdID == "Ak'xi'")] <- "Akxi"
smi$BirdID[which(smi$BirdID == "Bacmut bacni")] <- "Bacmut"
smi$BirdID[which(smi$BirdID == "Buñuelo")] <- "Bunuelo"
smi$BirdID[which(smi$BirdID == "Piña")] <- "Pina"
smi$BirdID[which(smi$BirdID == "Tzanatl preciosa")] <- "Tzanatl"
smi$BirdID[which(smi$BirdID == "Zapote Negro")] <- "Zapote"
smi$BirdID[which(smi$BirdID == "Dulce de Leche")] <- "Dulce"
...
########################################## Run search velocity analysis for AZ birds
 d_az = read.csv("~/Documents/Grackle project/Space use/Space Use Workflow/AZgracklePtsAviaryByWeek_new.csv")
 d_ind = read.csv("~/Documents/Grackle project/Space use/Space Use Workflow/GracklePtsAviaryByWeek.csv")
 ...
 smi = HR[,c(2,16)]
 colnames(smi)[1] = "Bird.Name"
 d_ind = merge(d_ind, smi, by = "Bird.Name")
 
 source("~/Documents/Grackle project/Space use/Space Use Workflow/Search_Velocity_Arizona.R")
 
########################################## Run search velocity analysis for CA birds
 d_ca = read.csv("~/Documents/Grackle project/Space use/Space Use Workflow/CAgracklePtsAviaryByWeek_new.csv")
 #d_ind = read.csv("~/Documents/Grackle project/Space use/Space Use Workflow/GracklePtsAviaryByWeek.csv")
