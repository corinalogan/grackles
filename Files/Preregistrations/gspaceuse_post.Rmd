...
library(DHARMa)
library(lme4)
simulationOutput <- simulateResiduals(fittedModel = lm(log(hr) ~ DurationNear + LatencyFirstLand + Site + Sex + Season2 + Breeding.Sites + Food.Sites + Group.Size + History + SMI, data=HR), n=250) 
...
# CA grackles had larger home range sizes
