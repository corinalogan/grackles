...
########################################## Load helper functions
 source("~/Documents/Grackle project/Space use/Space Use Workflow/Helper_Functions.R")
...
########################################## Run search velocity analysis for CA birds
 d_ca <- read.csv(url("https://raw.githubusercontent.com/corinalogan/grackles/refs/heads/master/Files/Preregistrations/gspaceuse_GracklePtsAviaryByWeek.csv"), header = T, sep = ",", stringsAsFactors = F)
