...
We will determine whether our space use variables vary by season (breeding or non-breeding). If season has no significant effect, all data will be included in our subsequent analyses. If there is a significant effect of season, we will run models separately for each dependent variable and each season. 
