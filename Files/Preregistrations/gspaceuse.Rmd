...
##add in season
AZpts.nb20 = AZpts[AZpts$Date < "2020-04-01",]
AZpts.nb = AZpts.nb20[-which(AZpts.nb20$Date > "2019-04-01"& AZpts.nb20$Date < "2019-08-31"),]
AZpts.b20 = AZpts[AZpts$Date > "2020-03-31",]
AZpts.b19 = AZpts[AZpts$Date > "2019-03-31"& AZpts$Date < "2019-09-01",]
AZpts.b = rbind(AZpts.b20, AZpts.b19)
#is there overlap where some grackles have data in both seasons?
unique(AZpts.b$BirdID)
unique(AZpts.nb$BirdID)

CApts.nb = CApts[CApts$Date > "2021-09-01" | CApts$Date < "2021-03-31",]
CApts.b = CApts[CApts$Date > "2021-03-31"& CApts$Date < "2021-09-01",]
#is there overlap where some grackles have data in both seasons?
unique(CApts.b$BirdID)
unique(CApts.nb$BirdID)
