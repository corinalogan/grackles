...
Great-tailed grackles are caught in the wild, given colored leg bands in unique combinations for individual identification, and released at their point of capture. The great-tailed grackles used in this study have one of two different backgrounds: those that do not have radio tags and those that do. First, we opportunistically track color-banded grackles that do not have a radio tag to determine whether time spent in the aviaries affects space use behavior. When a color-banded bird is encountered, researchers track it for 20-90 minutes, recording the spatial location every 1 minute. If the bird goes out of view, researchers attempt to find it again for up to 30 minutes before moving on. Because these data are opportunistic, we do not attempt to balance for sex. We currently have over 100 points on 6 individuals, and we aim to increase that to at least 10 in each population.
