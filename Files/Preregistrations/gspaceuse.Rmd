...
If movement behavior and spatial location choice is repeatable, then we will use the standard deviation of step length and turning angle, as well as the autocorrelation value among daily spatial preference matrices, for each individual to model the relationship with performance at our exploration tasks, and study site location. 
...
### Calculate home range in square meters for each individual, excluding no outliers (percent = 100)
