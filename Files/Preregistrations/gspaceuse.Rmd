...
**Prediction 2 alternative 2:** There is no difference across the geographic range in the space use behavior of grackles.  This suggests that, on average, all grackles may use the same amount of space, or that there is a similar distribution of individual differences in space use in each population.  Alternatively, grackles from the two populations may converge on similar space use behavior during development but we would not be able to distinguish this alternative prediction with our data. 
