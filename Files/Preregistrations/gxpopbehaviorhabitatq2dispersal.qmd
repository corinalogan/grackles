...
# Calculate for each individuals their pairwise relatedness to all other members of the group
...
# Here, each pair occurs twice - exclude these.
...
# coyp from gdispersal manuscript starting line 350
...
female_pairwise_distances <- distm(adultgracklelocations[idinfo$Sex=="F",c('Lon','Lat')], adultgracklelocations[adultgracklelocations$Sex=="F",c('Lon','Lat')], fun=distVincentyEllipsoid)
