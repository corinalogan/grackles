...
wo_input<-readgenotypedata("https://raw.githubusercontent.com/corinalogan/grackles/master/Files/Preregistrations/g_flexforaging_data_genepop_Woodland.txt")
...
wo_snpdata<-wo_input$gdata
wo_snpdata$V1<-gsub("-","",wo_snpdata$V1)
wo_snpdata<-wo_snpdata[wo_snpdata$V1 %in% adultids$BirdID,]
...
wo_outfile<-coancestry(wo_snpdata,wang=1,quellergt=1,lynchli=1)
...
hist(wo_completerelatedness$wang)
...
mean(filter(wo_completerelatedness,ind1.id %in% females,ind2.id %in% females)$wang)
mean(filter(wo_completerelatedness,ind1.id %in% males,ind2.id %in% males)$wang)
mean(wo_completerelatedness$wang)

var(filter(wo_completerelatedness,ind1.id %in% females,ind2.id %in% females)$wang)
var(filter(wo_completerelatedness,ind1.id %in% males,ind2.id %in% males)$wang)
var(wo_completerelatedness$wang)
...
mean(filter(wo_completerelatedness,ind1.id %in% females,ind2.id %in% females)$quellergt)
mean(filter(wo_completerelatedness,ind1.id %in% males,ind2.id %in% males)$quellergt)
mean(wo_completerelatedness$quellergt)

var(filter(wo_completerelatedness,ind1.id %in% females,ind2.id %in% females)$quellergt)
var(filter(wo_completerelatedness,ind1.id %in% males,ind2.id %in% males)$quellergt)
var(wo_completerelatedness$quellergt)
...
wo_completerelatedness<-left_join(wo_completerelatedness,birdsex,by="ind1.id")
colnames(birdsex)<-c("ind2.id","ind2.sex")
az_completerelatedness<-left_join(az_completerelatedness,birdsex,by="ind2.id")
wo_completerelatedness<-left_join(wo_completerelatedness,birdsex,by="ind2.id")
az_completerelatedness$sexdyad<-paste(az_completerelatedness$ind1.sex,az_completerelatedness$ind2.sex)
wo_completerelatedness$sexdyad<-paste(wo_completerelatedness$ind1.sex,wo_completerelatedness$ind2.sex)
...
wo_completerelatedness[which(wo_completerelatedness$sexdyad=="F F"),]$sexdyad<-"1"
wo_completerelatedness[which(wo_completerelatedness$sexdyad=="M F"),]$sexdyad<-"2"
wo_completerelatedness[which(wo_completerelatedness$sexdyad=="F M"),]$sexdyad<-"2"
wo_completerelatedness[which(wo_completerelatedness$sexdyad=="M M"),]$sexdyad<-"3"


dat_relatedness<-list(
  relatedness = c(az_completerelatedness$quellergt,wo_completerelatedness$wang),
  population = as.numeric(as.factor(c(rep(1,nrow(az_completerelatedness)),rep(2,nrow(wo_completerelatedness))))),
  sex = as.numeric(as.factor(c(az_completerelatedness$sexdyad,wo_completerelatedness$sexdyad)))
)
...
ca_closerelatives<-wo_pairwise_r[wo_pairwise_r$quellergt>0.249,]
birdsex<-adultids[,c(2,5)]
colnames(birdsex)<-c("ind1.id","ind1.sex")
...
ca_closerelatives<-wo_pairwise_r[wo_pairwise_r$wang>0.249,]
birdsex<-adultids[,c(2,5)]
colnames(birdsex)<-c("ind1.id","ind1.sex")
ca_closerelatives<-left_join(ca_closerelatives,birdsex,by="ind1.id")
colnames(birdsex)<-c("ind2.id","ind2.sex")
...
all_pairwise_distances <- distm(idinfo[,c('Lon','Lat')], idinfo[,c('Lon','Lat')], fun=distVincentyEllipsoid)
rownames(all_pairwise_distances)<-idinfo$Name
colnames(all_pairwise_distances)<-idinfo$Name
diag(all_pairwise_distances)<-NA

#Calculate pairwise distances among all the females in California
CA_female_pairwise_distances <- distm(idinfo[idinfo$Sex=="F" & idinfo$Population=="Woodland",c('Lon','Lat')], idinfo[idinfo$Sex=="F" & idinfo$Population=="Woodland",c('Lon','Lat')], fun=distVincentyEllipsoid)
rownames(CA_female_pairwise_distances)<-idinfo[idinfo$Sex=="F" & idinfo$Population=="Woodland",]$BirdID
colnames(CA_female_pairwise_distances)<-idinfo[idinfo$Sex=="F" & idinfo$Population=="Woodland",]$BirdID
diag(CA_female_pairwise_distances)<-NA

#Calculate pairwise distances among all the females in Arizona
AZ_female_pairwise_distances <- distm(idinfo[idinfo$Sex=="F" & idinfo$Population=="Tempe",c('Lon','Lat')], idinfo[idinfo$Sex=="F" & idinfo$Population=="Tempe",c('Lon','Lat')], fun=distVincentyEllipsoid)
rownames(AZ_female_pairwise_distances)<-idinfo[idinfo$Sex=="F" & idinfo$Population=="Tempe",]$BirdID
colnames(AZ_female_pairwise_distances)<-idinfo[idinfo$Sex=="F" & idinfo$Population=="Tempe",]$BirdID
diag(AZ_female_pairwise_distances)<-NA

#Calculate pairwise distances among all the males in California
CA_male_pairwise_distances <- distm(idinfo[idinfo$Sex=="M" & idinfo$Population=="Woodland",c('Lon','Lat')], idinfo[idinfo$Sex=="M" & idinfo$Population=="Woodland",c('Lon','Lat')], fun=distVincentyEllipsoid)
rownames(CA_male_pairwise_distances)<-idinfo[idinfo$Sex=="M" & idinfo$Population=="Woodland",]$BirdID
colnames(CA_male_pairwise_distances)<-idinfo[idinfo$Sex=="M" & idinfo$Population=="Woodland",]$BirdID
diag(CA_male_pairwise_distances)<-NA

#Calculate pairwise distances among all the males in Arizona
AZ_male_pairwise_distances <- distm(idinfo[idinfo$Sex=="M" & idinfo$Population=="Tempe",c('Lon','Lat')], idinfo[idinfo$Sex=="M" & idinfo$Population=="Tempe",c('Lon','Lat')], fun=distVincentyEllipsoid)
rownames(AZ_male_pairwise_distances)<-idinfo[idinfo$Sex=="M" & idinfo$Population=="Tempe",]$BirdID
colnames(AZ_male_pairwise_distances)<-idinfo[idinfo$Sex=="M" & idinfo$Population=="Tempe",]$BirdID
