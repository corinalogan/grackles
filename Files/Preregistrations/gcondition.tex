...
\hypersetup{
  ...
  pdfauthor={Berens JM1; Logan CJ2; Folsom M2; Sevchik A1; Bergeron L3; McCune KB3*},
  hidelinks,
...
\author{Berens JM\textsuperscript{1} \and \href{http://CorinaLogan.com}{Logan CJ}\textsuperscript{2} \and Folsom M\textsuperscript{2} \and Sevchik A\textsuperscript{1} \and Bergeron L\textsuperscript{3} \and \href{https://www.kelseymccune.com/}{McCune KB}\textsuperscript{3}*}
\date{2020-11-12}
...
Figure 1: A male grackle showing the yellow/orange tint of fat unnder
the skin in the intraclavicular depression, and a female grackle showing
\emph{no} fat under the skin of the intraclavicular region but
significant fat deposits under the skin of the abdomen.
...
3) so we did not include season as an independent variable in the final
models.
...
survive each day (Fig. 4). There was no statistically significant
...
relationship between fat score and daily nest survival is large (Fig. 4)
and potentially biologically meaningful. The odds of a nest surviving on
a given day are almost 2.5 times greater for birds with some fat (a
score of 1) compared to no fat (a score of 0).
