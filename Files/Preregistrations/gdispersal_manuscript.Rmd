...
---
##### Affiliations: 
1) Arizona State University, Tempe, Arizona, USA; 2) Max Planck Institute for Evolutionary Anthropology, Leipzig, Germany; 3) University of California Santa Barbara, Santa Barbara, California, USA; 4) Washington State University, Pullman, Washington, USA. *Corresponding author: dieter.lukas@eva.mpg.de
...
**This research article has been peer reviewed and received a Recommendation by:**
...
![](gdispersal_Figure1.png){width=90%}
...
All data necessary for the analyses are available at https://doi.org/10.5063/F1W66J48 [@lukas2020geneticdata] and the code is available at https://github.com/corinalogan/grackles/blob/master/Files/Preregistrations/gdispersal_manuscript.Rmd. The provided code will load these files directly from GitHub. 
