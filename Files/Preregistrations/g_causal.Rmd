...
author: "[Dr. Aaron Blaisdell](http://pigeonrat.psych.ucla.edu) (University of California Los Angeles, UCLA), Dr. Zoe Johnson-Ulrich (University of California Santa Barbara, UCSB), Luisa Bergeron (UCSB), Carolyn Rowney (Max Planck Institute for Evolutionary Anthropology, MPI EVA), Benjamin Seitz (UCLA), Dr. Kelsey McCune (UCSB), Melissa Folson (MPI EVA), [Dr. Corina Logan](http://CorinaLogan.com) (MPI EVA, corina_logan@eva.mpg.de)"
date: '`r Sys.Date()`'
output:
  html_document: 
    toc: true
...
**Seitz:** Programmed the touchscreen experiment, experimental design, revising/editing.
