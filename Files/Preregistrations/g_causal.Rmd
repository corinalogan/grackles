...
author: "[Blaisdell A](http://pigeonrat.psych.ucla.edu) (University of California Los Angeles, UCLA), Johnson-Ulrich Z (University of California Santa Barbara, UCSB), Bergeron L (UCSB), Rowney C (Max Planck Institute for Evolutionary Anthropology, MPI EVA), Seitz B (UCLA), McCune KB (UCSB), Folsom M (MPI EVA), MacPherson M (UCSB), [Logan CJ](http://CorinaLogan.com) (MPI EVA, corina_logan@eva.mpg.de)"
date: '`r Sys.Date()`'
output:
  html_document: 
    toc: true
...
**Cite as:** Blaisdell A, Johnson-Ulrich Z, Bergeron L, Rowney C, Seitz B, Folsom M, McCune K, Logan CJ. 2019. Do the more flexible individuals rely more on causal cognition? Observation versus intervention in casual inference in great-tailed grackles. (version: [31 Jan 2019](https://github.com/corinalogan/grackles/blob/master/Files/Preregistrations/g_causal.Rmd)) In Principle Recommendation by PCI Ecology.
