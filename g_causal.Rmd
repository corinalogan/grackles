...
Figure 1. Test figures adapted from @blaisdell2006causal.
...
Contingency training follows the procedure outlined in Figure 1. The light is a yellow circle (6cm diameter), the tone is 400hz presented for 10s, and the noise is a white noise presented for 10s. In the first training phase, subjects will receive trials during which the yellow circle will be presented on the screen followed by presentation of the tone. The circle and tone will each be presented for 10s with the onset of the tone coinciding with the termination of the circle. During the second training phase, subjects will receive two types of trials interspersed within each training session. On some trials, the circle will be presented for x seconds followed by the delivery of food from the hopper. On other trials, the 10s noise and 10s delivery of food will onset and terminate together.
