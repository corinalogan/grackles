...
2) Number of trials to [reverse a preference](./g_flexmanip.html) in the last reversal that individual participated in

3) Average latency to attempt to solve a new loci after solving a different loci ([multi-access box](./g_flexmanip.html))
