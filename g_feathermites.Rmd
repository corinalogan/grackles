...
author: '[Dr. Jay Taylor](https://math.la.asu.edu/~jtaylor/) (Arizona State University) and [Dr. Corina Logan](http://CorinaLogan.com) (University of Cambridge, cl417@cam.ac.uk)'
date: '`r Sys.Date()`'
output:
...
**Taylor:** Hypothesis development, materials, data collection, data analysis and interpretation, write up.

**Logan:** Hypothesis development, data analysis and interpretation, editing/revision, funding.
...
We thank...[to be filled in later].
