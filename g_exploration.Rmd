...
Individuals show consistent individual differences in behavior if the variance in latency to approach the task is smaller within individuals compared to variance in latency among individuals.

**P6:** There is no repeatibility of persistence, exploration and boldness within individuals, which could indicate that performance is state dependent (e.g., it depends on their fluctuating motivation, hunger levels, etc.) and/or reliant on the current context of the task at hand. 

**P6 alternative 1:** There is limited repeatability of persistence, exploration and boldness within individuals (Repeatability = 0.3-0.4 @bell2009repeatability), which could indicate that prior experience influences performance on tasks and facilitates the manipulation of these traits (e.g., individuals can change their behavior).  

**P6 alternative 2:** There is significant repeatibility of persistence, exploration and boldness within individuals, which could indicate that it is a property of the individual (e.g., due to heritability or developmental effects).
...
1) Boldness: Latency to land on the table - OR - Latency to eat the food - OR - Latency to touch a threatening object that is next to food (we will choose the variable with the most data)
...
7) Latency to land on the table - OR - Latency to eat the food - OR - Latency to touch a threatening object that is next to food (choose the variable with the most data)
