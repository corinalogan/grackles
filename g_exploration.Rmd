...
If behavior is repeatable within individuals, measured by conducting the same assays six weeks apart, we will test for the relationship between flexibility and exploration, and flexibility and boldness. If behavior is not repeatable across the first and second assay for exploration or boldness, we will not include these variables in analyses involving flexibility.
