...
#females
f1 <- MCMCglmm(NumberFoodsEaten ~ TrialsToReverseLast + NumberForagingTechniques + ExperimentalGroup + DominanceRank, random=~Population+ID, family="poisson", data=fem, verbose=F, prior=prior, nitt=130000, thin=10, burnin=30000)
summary(f1)
