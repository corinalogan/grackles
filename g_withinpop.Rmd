...
**P8 alternative 1:** If there is a positive relationship between flexibility and parasite loads, this could be because the more flexible individuals 1) eat a wider range of foods and are thus exposed to more parasites, and/or 2) might be in poorer energetic condition and more susceptible to hosting more species.
...
#### H7: Individuals that are more behaviorally flexible have higher fitness.

**P10:** The more flexible individuals will choose mates that are also more flexible. Flexibility will be measured in a separate [preregistration](./g_flexmanip.Rmd) and mate choice will be determined by genetically identifying the parents of offspring using ddRADseq.

**P11:** The roaming males (males without territories during the breeding season) will be more flexible and have higher paternity rates than territory-holding males. Roaming males must sneak copulations with females who nest within another male's territory, which could select for an increase in flexible behavior. Flexibility will be measured in a separate [preregistration](./g_flexmanip.Rmd), paternity will be identified using ddRADseq, and territory-holding males will be identified using behavioral observations.

**P12:** The more flexible females will be better at keeping offspring alive. Flexibility will be measured in a separate [preregistration](./g_flexmanip.Rmd) and offspring survival will be measured through maternity identification (using ddRADseq) of offspring who survived past one year of age.

**P13:** Alternatively, there might be no correlation or a negative correlation between flexibility and fitness due to there being direct and/or indirect trade offs between these variables. One trade off might be that flexible males are good at sneaking extra-pair copulations (roaming males), but not at holding a territory, which requires outcompeting other males. Flexibility will be measured in a separate [preregistration](./g_flexmanip.Rmd), paternity will be identified using ddRADseq, and territory-holding males will be identified using behavioral observations.

**P14:** In another alternative for males, there might be no correlation or a negative correlation between flexibility and fitness because flexible males might be good at surviving, but not at attracting mates (measured through paternity). Flexibility will be measured in a separate [preregistration](./g_flexmanip.Rmd) and paternity will be identified using ddRADseq.

**P15:** In another alternative for females, there might be no correlation or a negative correlation between flexibility and fitness because flexible females might be good at surviving, but not at keeping offspring alive (measured through maternity). Flexibility will be measured in a separate [preregistration](./g_flexmanip.Rmd) and maternity will be determined using ddRADseq to identify offspring who survived past one year of age.
...
3) Flexibility 1: Number of trials to reverse last preference (see above)

4) Flexibility 2: Flexibility ratio (see above)
