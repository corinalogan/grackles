...
**R2.1 population** Are there genetic variants at specific loci that are more common in edge populations that might be linked with higher flexibility?

**R2.2 individual** Do the more flexible individuals carry or express genetic variants at specific loci that differ from the less flexible individuals? Genetic variants will be identified using genome wide association studies (GWAS).

**R2.3 candidate loci** Is one variant of the genetic locus DRD4 (associated with exploratory behavior) primarily present in the more flexible individuals, while the other variant is primarily present in the less flexible individuals?
...
####*R2.1: Are there genetic variants at specific loci that are more common in edge populations that might be linked with higher flexibility?*



####*R2.2: Do the more flexible individuals carry or express genetic variants at specific loci that differ from the less flexible individuals?*



####*R2.3: Is one variant of the genetic locus DRD4 (associated with exploratory behavior) primarily present in the more flexible individuals*
...
1) Population: Central America, Arizona, Nebraska
